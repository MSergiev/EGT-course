lib1.h
	...
	(+)2. lib function that prints an array (initially specific types, later generic/template) or
	matrix, including columns, spacing tweaking
	...
	(+)5. lib functions to help with random stuff: picking a number from a range, picking a 
