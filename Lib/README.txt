lib1.h
	...
	(+)5. lib functions to help with random stuff: picking a number from a range, picking a double,	selecting one or many items from an array, shuffling array, random queue (put
